...
public class ReporteMedicoExcelExporter {
    ...
    public byte[] exportar(List<Medico> medicos) {
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            int[] widths = {1500, 5500, 3000, 3500, 2500, 6000, 3000, 3000};
            for (int i = 0; i < widths.length; i++) {
                sheet.setColumnWidth(i, widths[i]);
            }

            // Ocultar cuadrícula y márgenes
            ...
            cellSubtitulo.setCellValue("Reporte de Médicos");
            ...
            Cell cellFecha = rowFecha.createCell(7);
            ...
            Cell cellHora = rowHora.createCell(7);
            ...
            String[] headers = {"ID", "Nombre Completo", "DNI", "Colegiatura", "Años Exp.", "Especialidades", "Teléfono", "Ubicación"};
            ...
            workbook.setPrintArea(workbook.getSheetIndex(sheet), 0, headers.length - 1, 0, ultimaFila);
            ...
            throw new RuntimeException("Error generando el Excel de médicos", e);
        }
    }
}
